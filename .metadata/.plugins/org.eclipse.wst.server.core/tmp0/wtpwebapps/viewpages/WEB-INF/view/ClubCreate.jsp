...
.wrap {background-color : #EFEEF5; padding-bottom : 5vh; }
      ...
      <div id="contents">
            <form action="clubinsert.action" method="post" id="clubForm" enctype="multipart/form-data">
               <div class="club_title">
                  <p>
                  동아리명<input type="text" name="title" id="title" class="title" style="color :black;">
                  </p>
                  <span id="checkTitle" style="font-size: small;"></span><br>
               </div> 
               <div class ="profile_photo">
              <p>프로필 사진</p><input type="file" name="url" id="url" style="color: white; background: gray; border-radius: 5px; padding: 5px;">
              </div>
                  ...
                  <br>
                  <div>
                     내용<br><br><textarea rows="10" cols="70" id="content" name="content"></textarea>
                  </div>
               <br><br>
               <div>
