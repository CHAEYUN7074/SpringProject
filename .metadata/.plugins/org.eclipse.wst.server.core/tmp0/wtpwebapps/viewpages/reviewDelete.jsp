...
<body>
	...
	<div class="contents">
		<div class="includeDelete">
			<input type="checkbox" value="999" />999
			<div class="card mb-3">
				<div class="row g-0">

					<div class="col-md-4">
						<img
							src="http://artinsight.co.kr/data/tmp/1806/8a7aa7b2cc1c8658726cc7a2df93418f_Kthlez4CFNiI72tb12Chqdw.jpg"
