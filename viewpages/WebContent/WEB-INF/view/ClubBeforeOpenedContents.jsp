                     ...
                     <div>
                        ...
                        <c:choose>
                           ...
                           <c:when test="${joinCheck eq -1}"> <!-- 가입신청이 안되어있으면 지원하기 보임 -->
                              <input type="button" class="btn btn-success btn-sm" value="지원하기" id="applyBtn1" >
                           </c:when>
                           <c:when test="${joinCheck eq 3}"> <!-- 이미 해당 포지션에 지원 했다면 지원취소 보임 -->
                              <input type="button" class="btn btn-secondary btn-sm" value="지원취소" id="cancleBtn1" >
                           </c:when>
                        </c:choose>
                     <!-- 
                     ...
                     <div>
                        ...
                        <c:choose>
                           ...
                           <c:when test="${joinCheck eq -1}">
                              <input type="button" class="btn btn-success btn-sm" value="지원하기" id="applyBtn2" >
                           </c:when>
                           <c:when test="${joinCheck eq 2}">
                              <input type="button" class="btn btn-secondary" value="지원취소" id="cancleBtn2" >
                           </c:when>
                        </c:choose>
